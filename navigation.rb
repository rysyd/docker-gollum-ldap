module Gollum
  class Macro
    class Navigation < Gollum::Macro
      ...
      def render(title = "Navigate this directory", toc_root_path = nil, full_path = false)

        if !toc_root_path
          toc_root_path =::File.dirname(
            @page.sub_page && @page.parent_page ? @page.parent_page.url_path : @page.url_path
          )
        end
